...
ALTER TABLE `uimpx`.`sys_menu` ADD COLUMN `tenant_id` int(11) UNSIGNED NULL DEFAULT 1 COMMENT '租户ID' AFTER `del_flag`;

DROP TABLE IF EXISTS `uimpx`.`sys_oauth_client_details`;
CREATE TABLE `uimpx`.`sys_oauth_client_details` (
...
-- ----------------------------
BEGIN;
INSERT INTO `uimpx`.`sys_oauth_client_details` VALUES (1, 'app', NULL, 'app', 'server', 'password,refresh_token,authorization_code,client_credentials,implicit', NULL, NULL, 43200, 2592001, NULL, 'true', '0', 1);
INSERT INTO `uimpx`.`sys_oauth_client_details` VALUES (2, 'daemon', NULL, 'daemon', 'server', 'password,refresh_token', NULL, NULL, NULL, NULL, NULL, 'true', '0', 1);
INSERT INTO `uimpx`.`sys_oauth_client_details` VALUES (3, 'gen', NULL, 'gen', 'server', 'password,refresh_token', NULL, NULL, NULL, NULL, NULL, 'true', '0', 1);
INSERT INTO `uimpx`.`sys_oauth_client_details` VALUES (4, 'mp', NULL, 'mp', 'server', 'password,refresh_token', NULL, NULL, NULL, NULL, NULL, 'true', '0', 1);
INSERT INTO `uimpx`.`sys_oauth_client_details` VALUES (5, 'pig', NULL, 'pig', 'server', 'password,refresh_token,authorization_code,client_credentials', 'http://localhost:4040/sso1/login,http://localhost:4041/sso1/login,http://localhost:8080/renren-admin/sys/oauth2-sso,http://localhost:8090/sys/oauth2-sso', NULL, NULL, NULL, NULL, 'false', '0', 1);
INSERT INTO `uimpx`.`sys_oauth_client_details` VALUES (6, 'test', NULL, 'test', 'server', 'password,refresh_token', NULL, NULL, NULL, NULL, NULL, 'true', '0', 1);
COMMIT;

UPDATE `uimpx_job`.`xxl_job_group` SET `app_name` = 'xxl-job-executor', `title` = '示例执行器', `order` = 1, `address_type` = 0, `address_list` = NULL WHERE `id` = 1;

DROP TABLE `uimpx_job`.`job_execution_log`;

DROP TABLE `uimpx_job`.`job_status_trace_log`;
